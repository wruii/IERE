...
class Decoder(nn.Module):
    def __init__(self, params):
        ...
        self.out_conv_t = nn.Conv2d(self.ft_chns[0], self.n_class, kernel_size=3, padding=1)
        self.out_conv_s = nn.Conv2d(self.ft_chns[0], self.n_class, kernel_size=3, padding=1)
    ...
    def forward(self, feature):
        ...
        output_t = self.out_conv_t(x_last)
        output_s = self.out_conv_s(x_last)
        return output_t, output_s, x_last
...
class UNet(nn.Module):
    ...
    def forward(self, batch):
        ...
        output_t, output_s, features = self.decoder(feature)
